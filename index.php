...
<div class="auth-wrapper">
	<div class="auth-content text-center">
		<h4>Complaint management system <hr /><span style="color:#fff;"> Student Login</span></h4>
				...
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						<div class="form-group mb-3">
							...
							<input type="email" name="emailid" id="emailid" class="form-control" onBlur="emailAvailability()" required placeholder="Enter Email ID">
						</div>
