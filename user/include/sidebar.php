...
?>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="../base.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">AI ASSISTANT</span></a>
					</li>

					    <a href="standalone-frontend/base.html"><button class="btn">Contact Now</button></a>
