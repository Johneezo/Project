...
<head>
    <title>Student Complaint Management System || Dashboard</title>
...
?>
                            ...
                            <a href="complaint-history.php"> <h6>Total Complaints</h6></a>
                        </div>
                    </div>
                </div>
...
?>
                            <h4><?php echo $newcom;?></h4>
                             <a href="complaint-history.php"><h6>Pending Complaints</h6>
                        </div></a>
                    </div>
                </div>
                <!-- widget-success-card end -->
...
?>
                            <h4><?php echo $inprocesscom;?></h4>
                             <a href="complaint-history.php"><h6>Inprocess Complaints</h6></a>
                        </div>
                    </div>
                </div>
...
?>
                           ...
                           <a href="complaint-history.php"><h6>Closed Complaints</h6></a>
                        </div>
                    </div>
                </div>
...
-->
<script>
(function(){if(!window.chatbase||window.chatbase("getState")!=="initialized"){window.chatbase=(...arguments)=>{if(!window.chatbase.q){window.chatbase.q=[]}window.chatbase.q.push(arguments)};window.chatbase=new Proxy(window.chatbase,{get(target,prop){if(prop==="q"){return target.q}return(...args)=>target(prop,...args)}})}const onLoad=function(){const script=document.createElement("script");script.src="https://www.chatbase.co/embed.min.js";script.id="y40eUq6EfyCSi-aM3yQSA";script.domain="www.chatbase.co";document.body.appendChild(script)};if(document.readyState==="complete"){onLoad()}else{window.addEventListener("load",onLoad)}})();
</script>
